    ...
    function renderActiveResultsView(apiResponse) {
        ...
        if (totalItems === 0) {
            ...
            fragment.appendChild(noResultsRow);
             ...
             const colspanValue = allFilesTableHead?.rows[0]?.cells?.length || 6; // Get colspan based on header once
            ...
            searchInput.addEventListener('blur', () => {
                ...
                setTimeout(() => {
                     ...
                     if (document.activeElement !== searchInput &&
                         suggestionsContainer && // Check if suggestionsContainer exists before accessing contains
